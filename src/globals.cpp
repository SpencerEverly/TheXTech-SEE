...
RangeArr<std::string, 0, maxSections> CustomMusic2;
RangeArr<std::string, 0, maxSections> CustomMusic3;
RangeArr<std::string, 0, maxSections> CustomMusic4;
RangeArr<std::string, 0, maxSections> CustomMusic5;
int numSections = 0;
...
RangeArrI<bool, 0, maxNPCType, false> NPCNoBubbleTransform;
...
void initAll()
{
    ...
    CustomMusic2.fill(std::string());
    CustomMusic3.fill(std::string());
    CustomMusic4.fill(std::string());
    CustomMusic5.fill(std::string());
